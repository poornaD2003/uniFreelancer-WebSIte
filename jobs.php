...
$stmt = $pdo->query("SELECT j.*, u.fullname as student_name 
                     FROM gigs j 
...
<p style="color: var(--text-muted); margin-bottom: 1.5rem;"><?php echo htmlspecialchars(substr($job['description'], 0, 100)) . '...'; ?></p>                    <div style="display: flex; justify-content: space-between; align-items: center;">
